...
export default function App() {
  ...
  // Endgame reveal states
  const [endMascot, setEndMascot] = useState<'solis' | 'selena' | null>(null);
  const [showEndStamp, setShowEndStamp] = useState<boolean>(false);
...
const spawnKuman = useCallback(() => {
  ...
  // Reveal mascot first, then stamp badge on endgame screen
  useEffect(() => {
    ...
    <div id="app_root" className="min-h-screen bg-orange-50 text-gray-800 font-sans px-4 py-4 md:p-6 flex flex-col items-center justify-start selection:bg-orange-200">
      ...
      <header className="w-full max-w-4xl flex items-center justify-between gap-3 mb-4 mt-2">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-3">
            <img
              src="/games/tap-tap-kuman/logo%20sobat%20anak.png"
              alt="Logo Sobat Anak"
      ...
      <section className="w-full max-w-4xl mt-1 mb-4 md:mb-6 px-1 grid grid-cols-3 gap-2.5 md:gap-5 select-none">
        ...
        <div 
          id="time_panel" 
          className={`timer-card-stable bg-white border-2 md:border-3 rounded-2xl md:rounded-3xl p-2 md:p-4 flex items-center justify-center md:justify-start shadow-lg relative h-16 md:h-28 select-none transition-colors duration-200 ${
            gameState === 'PLAYING' && timeLeft <= 5 
              ? 'border-red-500 animate-shaky-warning' 
...
/>
        ...
        {gameState === 'START' && (
          <div className="tap-start-screen relative z-10 w-full h-full overflow-hidden animate-fade-in">
            <div className="tap-start-visual" aria-hidden="true">
              <img
                src="/games/tap-tap-kuman/start-assets/selena-guard.png"
                alt=""
                className="tap-start-selena"
                draggable={false}
              />

              <img
                src="/games/tap-tap-kuman/start-assets/kuman1.png"
                alt=""
                className="tap-start-germ tap-start-germ-one"
                draggable={false}
              />
              <img
                src="/games/tap-tap-kuman/start-assets/kuman2.png"
                alt=""
                className="tap-start-germ tap-start-germ-two"
                draggable={false}
              />
              <img
                src="/games/tap-tap-kuman/start-assets/kuman3.png"
                alt=""
                className="tap-start-germ tap-start-germ-three"
                draggable={false}
              />
            </div>

            <div className="tap-start-copy">
              <h1>TAP-TAP KUMAN</h1>
              <p>
                Bantu hilangkan kuman jahat dengan mengetuk mereka
                secepat mungkin!
              </p>
        ...
        {gameState === 'FINISHED' && (
          <div className="relative z-10 p-4 md:p-6 text-center max-w-3xl flex flex-col items-center justify-center animate-pop-in w-full">
            ...
            <div className="tap-end-hero tap-end-hero-reset">
              {endMascot && (
                <img
                  src={endMascot === 'solis' ? '/games/tap-tap-kuman/end-assets/solis-jempol.png' : '/games/tap-tap-kuman/end-assets/selena-jempol.png'}
