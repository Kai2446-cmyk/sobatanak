...
Route::get('/profile/purchases', [AuthController::class, 'purchaseHistory'])->name('profile.purchases');
...
Route::post('/product-reviews/{review}/like', [ProductReviewController::class, 'like'])->name('review.like');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/articles/import-document', [ArticleImportController::class, 'import'])->name('articles.import-document');
    ...
    Route::get('/games/{gameSetting}', [AdminController::class, 'editGame'])->name('games.edit');
