    ...
    <div class="checkout-result-card">
        ...
        @if($hasOrder)
            ...
            <div class="checkout-result-summary">
                ...
                @if((int)($order->voucher_discount ?? 0) > 0)
                    <div><span>Voucher {{ $order->voucher_code ? '(' . $order->voucher_code . ')' : '' }}</span><b>- Rp {{ number_format($order->voucher_discount,0,',','.') }}</b></div>
                @endif
            ...
            <div class="checkout-result-actions">
                ...
                @endif
                <a href="{{ route('profile.purchases') }}" class="result-btn primary">Lihat Riwayat</a>
