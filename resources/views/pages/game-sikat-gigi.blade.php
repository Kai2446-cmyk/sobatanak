...
@push('game_assets')
<link rel="stylesheet" href="{{ asset('games/sikat-gigi/dist/assets/index-DZx-lYHJ.css') }}">
<script type="module" src="{{ asset('games/sikat-gigi/dist/assets/index-DzdVRguj.js') }}"></script>
@endpush
