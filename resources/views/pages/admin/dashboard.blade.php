...
<div class="adm-card" style="margin-bottom:1.2rem">
    ...
    <div class="adm-row">
        <img src="{{ $product->image }}" class="adm-thumb" onerror="this.onerror=null;this.src='{{ asset('images/article-placeholder.jpg') }}'">
...
<div class="adm-bottom-grid">
    <div class="adm-card">
        ...
        <div class="adm-row">
            <img src="{{ $product->image }}" class="adm-thumb adm-thumb-sm" onerror="this.onerror=null;this.src='{{ asset('images/article-placeholder.jpg') }}'">
            <div class="adm-row-info">
    ...
    <div class="adm-card">
        ...
        <div class="adm-row">
            <img src="{{ $article->image }}" class="adm-thumb adm-thumb-sm" onerror="this.onerror=null;this.src='{{ asset('images/article-placeholder.jpg') }}'">
            <div class="adm-row-info">
