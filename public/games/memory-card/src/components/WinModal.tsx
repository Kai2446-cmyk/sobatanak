...
export function WinModal({ themeName, score, moves, onBack, onRestart }: WinModalProps) {
  const isSolisTheme = themeName === 'animals' || themeName === 'fruits';
  const characterImage = isSolisTheme ? '/games/memory-card/dist/wl-modals/solis-win.png' : '/games/memory-card/dist/wl-modals/selena-win.png';
        ...
        <div className="text-center relative z-10">
          ...
          <div className="bg-white/30 rounded-xl p-3 mb-5">
            <p className="text-gray-800 text-sm md:text-base">
              🌟 Luar biasa! Kamu berhasil menyelesaikan game!
            </p>
          </div>
