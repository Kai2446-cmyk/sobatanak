...
@push('game_assets')
<link rel="stylesheet" href="{{ asset('games/keranjang-sehat/dist/assets/index-DgaM4sq1.css') }}">
<script type="module" src="{{ asset('games/keranjang-sehat/dist/assets/index-DMPmXKQu.js') }}"></script>
@endpush
...
<style>
    ...
    .keranjang-sehat-shell{position:relative;background:transparent!important;min-height:100vh;padding:0}
    ...
    .game-point-chip{pointer-events:auto;background:#fff;border:1px solid #86efac;color:#2A3D3C;border-radius:999px;padding:10px 16px;font-weight:1000;white-space:nowrap;box-shadow:0 10px 25px rgba(42,61,60,.06)}
