...
<section class="max-w-7xl mx-auto px-6 md:px-12 py-10 admin-post-section">
    ...
    <form method="POST" action="{{ route('admin.articles.bulk-destroy') }}" data-confirm-submit="Hapus semua artikel yang dipilih?" class="admin-post-list-form">
        @csrf
        @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    document.querySelectorAll('.js-delete-post').forEach(button => {
        button.addEventListener('click', function(){
            ...
            window.SobatAnakConfirm.open('Hapus artikel ini dari daftar SobatAnak?', function(){
