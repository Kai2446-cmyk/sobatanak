        ...
        <div class="auth-split-form-panel">
            ...
            <form method="POST" action="{{ route('login.post') }}" class="auth-modern-form auth-loading-form">
                ...
                <div class="auth-form-options">
                    ...
                    <a href="{{ route('password.request') }}" class="auth-slide-nav" data-auth-slide="right">Forgot password?</a>
                </div>

                <button class="auth-submit-btn" type="submit" data-loading-text="Masuk...">Sign In</button>
            </form>

            <p class="auth-switch-text">Belum punya akun? <a href="{{ route('register') }}" class="auth-slide-nav" data-auth-slide="right">Create</a></p>
        </div>
