  ...
  return (
    <div className="flex flex-col items-center text-center justify-center py-6 px-4 md:py-10 select-none relative w-full overflow-hidden">
      ...
      <button 
        ...
        className="active:translate-y-1 active:border-b-2 cursor-pointer text-white font-fredoka font-black text-xl tracking-wider uppercase rounded-full bg-[#00C853] hover:bg-[#00E676] border-b-[6px] border-[#009624] px-16 md:px-20 py-5 md:py-6 min-w-[260px] md:min-w-[320px] flex items-center justify-center space-x-3.5 transition-all duration-100 shadow-[0_6px_20px_rgba(0,200,83,0.25)] z-10"
      >
        <span className="text-[17px] leading-none mb-0.5">▶</span>
        <span className="leading-none tracking-widest text-[20px] md:text-[24px]">Mulai Game</span>
      </button>
