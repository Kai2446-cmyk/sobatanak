...
class AdminController extends Controller
{
    ...
    public function editGame(GameSetting $gameSetting)
    {
        $admin = $this->adminUser();
        if (!$admin instanceof User) return $admin;

        return view('pages.admin.game-setting', compact('admin', 'gameSetting'));
    }
    ...
    public function testimonials(\Illuminate\Http\Request $request)
    {
        $admin = $this->adminUser();
        if (!$admin instanceof User) return $admin;
        ...
        $query = Testimonial::with('user')->withCount('likes as real_likes_count');
        ...
        if ($sort === 'newest') {
            ...
            $query->orderByDesc('real_likes_count')
        ...
        return view('pages.admin.testimonials', compact('admin','testimonials','rating','sort','ratingCounts'));
    }
