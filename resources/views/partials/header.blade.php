            ...
            <div class="relative profile-menu">
                <button data-profile-toggle class="profile-btn">
                    @if($authUser->avatar_url)
                        <img src="{{ $authUser->avatar_url }}" class="profile-avatar header-profile-photo" alt="{{ $authUser->name }}">
                    @else
                        <span class="profile-avatar header-profile-empty" aria-label="Belum ada foto profil"></span>
                    @endif
